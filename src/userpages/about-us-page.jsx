...
function About() {
  ...
  return (
    <div className="">
      {/* from us */}
      <Navbar />
      <section className=" mb-10  p-6 w-screen h-screen flex flex-col xs:flex-col sm:flex-row justify-center gap-20 items-center">
        {/* <div> */}
        <div>
        ...
        <div className="flex-col items-center justify-between align-middle gap-10">
          <div>
            <span className="font-extrabold font-montserrat text-primary-400 text-3xl">
              From your very own
            </span>
          </div>
          <div>
            <button className="px-5 py-3 rounded-[20px] font-montserrat self-center bg-primary-300">
              Join the team
            </button>
          </div>
        </div>
      ...
      {/* get to know us */}
      <section className=" w-screen h-full md:h-screen mb-20">
        <div className="bg-primary-300 py-[2px] w-[75%] mx-auto mb-[150px]"></div>
      ...
      <section className="w-[90%] mx-auto h-screen content-center">
        <div>
          <h1 className="text-primary-400 font-semibold font-montserrat text-3xl mb-10">
            Get to know us
          </h1>
      ...
      <section className="w-[90%] mx-auto h-full mb-[30%]">
        <div>
          <h1 className="text-primary-400 font-semibold font-montserrat text-3xl mb-10">
      ...
      <section className="w-[90%] mx-auto h-screen  flex flex-col my-auto sm:flex-row content-center self-center font-montserrat gap-20">
        <div>
